...
export const PetSchema = z.object({
        ...
        created_at: z.date().describe("The timestamp that the pet was created at"),
        updated_at: z.date().describe("The timestamp that the pet was last updated.")
})
...
export const ModifyPetSchema = z.object({
    ...
    updated_at: z.date().optional().describe("The current timestamp when you are sending the request")
})

export const ConversationMessage = z.object({
    id: z.string().describe("The ID of the specific conversation message."),
    ...
    created_at: z.date().describe("The timestamp the message was sent."),
    usage: z.object({
